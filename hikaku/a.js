...
function controlLED(messge){
        ...
        if (messge.data[0] == "pen" && messge.data[1] == 1 && messge.data[2] == "LEDon"){
            LEDon();
            console.log("ON");
            console.log("LEDをオンにしました");
        } else if (messge.data[0] == "pen" && messge.data[1] == 1 && messge.data[2] == "LEDoff"){
            console.log("OFF");
